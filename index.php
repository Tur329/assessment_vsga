...
<html lang="en">
                ...
                <nav class="navbar navbar-light bg-light navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-light" id="navbarCollapse">
                        ...
                        <div class="d-flex align-items-center flex-nowrap pt-xl-0" style="margin-left: 15px;">
                            <a href="#" class="btn-hover-bg btn btn-primary text-white py-2 px-4 me-3" data-bs-toggle="modal" data-bs-target="#modallogin">Login</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modallogin" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="causes-item">
                                <div class="causes-img">
                                    <img src="img/<?php echo $row['product_gambar']; ?>" class="img-fluid w-100" alt="Image">
                                </div>
